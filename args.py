...
def add_args(parser):
    ...
    parser.add_argument('--data_dir', type=str, default="./meshes/cross/",
                        help="Path to the training data")
    parser.add_argument('--inter_pcd', type=str, default="./inter_meshes/cross/")
    parser.add_argument('--train_list', type=str, default="./training_list/cross.txt")
    ...
    parser.add_argument('--log_name', type=str, default='cross', help="Name for the log dir")
